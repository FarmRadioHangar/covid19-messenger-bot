...
exports.how_the_virus_is_spread = (chat) => {
 ...
 buttons: [
      { type: 'web_url', title:"Read more", url: 'https://log.uliza.fm/api/v1/covid19/topic/am/HOW_THE_VIRUS_IS_SPREAD',webview_height_ratio: "COMPACT",
...
exports.symptoms_of_infection = (chat) => {
 ...
 buttons: [
      { type: 'web_url', title:"Read more", url: 'https://log.uliza.fm/api/v1/covid19/topic/am/SYMPTOMS_OF_INFECTION',webview_height_ratio: "COMPACT",
          messenger_extensions: true},
      { type: 'postback', title: 'Go back', payload:'GO_BACK' }
    ]
 })
...
exports.myths_misinformation = (chat) => {
 ...
 buttons: [
      { type: 'web_url', title:"Read more", url: 'https://log.uliza.fm/api/v1/covid19/topic/am/MYTHS_MISINFORMATION',webview_height_ratio: "COMPACT",
          messenger_extensions: true},
          { type: 'postback', title: 'Go back', payload:'GO_BACK' }
    ]
 })
...
exports.safety_for_broadcasters = (chat) => {
 ...
 buttons: [
      { type: 'web_url', title:"Read more", url: 'https://log.uliza.fm/api/v1/covid19/topic/am/SAFETY_FOR_BROADCASTERS',webview_height_ratio: "COMPACT",
          messenger_extensions: true},
          { type: 'postback', title: 'Go back', payload:'GO_BACK' }
    ]
